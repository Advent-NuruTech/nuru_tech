      ...
      <div className="grid gap-12 lg:grid-cols-2">
        <div className="p-8 rounded-xl bg-white dark:bg-neutral-900 shadow-lg border border-gray-100 dark:border-neutral-800">
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              <div className="bg-blue-100 dark:bg-purple-900 p-3 rounded-lg mr-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-600 dark:text-purple-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-1">Email Us</h3>
                <p className="text-gray-600 dark:text-gray-300">nurutech36@gmail.com</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-1">Call Us</h3>
                <p className="text-gray-600 dark:text-gray-300">+254105178685</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-1">Visit Us</h3>
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 dark:border-neutral-800">
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-4">Business Hours</h3>
